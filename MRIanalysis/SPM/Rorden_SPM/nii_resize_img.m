function nii_resize_img(imnames, Voxdim, BB, ismask)
% resample images to have specified voxel dims and bounding box
%Examples
%  nii_resize_img('C:\dir\img.nii',[2 2 2],[  -90 -126  -72;  90   90  108],false);
%  nii_resize_img('C:\dir\img.nii',[1 1 1],[  -90 -126  -72;  90   90  108],false);
...
for V=vols'
    ...
    %delete previous file - otherwise if previous file was e.g. 20mb and new file is 2Mb, a new file of 20Mb is created
    if nii_filedir_exists(VO.fname,0) ~= 0
    	nii_delete(VO.fname);
    end;
