...
%
%==========================================================================
if nargin == 0                           % If no input was provided, use defaults:
...
if PlaybackMode == 1
    InitializePlaybackMode;                                                 	% Initialize PsychPortAudio at standard latency
...
elseif PlaybackMode == 0
    ...
    SampleRate = Snd('DefaultRate');     % Get default audio sample rate
    if exist('Noise','var')
        Noise = (rand([1, SampleRate*Noise.Duration])*2)-1;
    end
