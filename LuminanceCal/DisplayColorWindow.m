function [fig_id,success]=DisplayColorWindow(rgb,fullscr_flg,fig_id)
...
% Last Update: "2012-04-25 18:11:08 ban"
...
try
  ...
  if ~fullscr_flg
    scrpos=[scrsz(3)/4,scrsz(4)/4,2*scrsz(3)/4,2*scrsz(4)/4];
  else
    scrpos=scrsz;
  end
