function [LeftGamma, RightGamma] = AnalyseLuminances(LumFile,fitType,SaveCLUT)
...
if nargin < 1
    Default = '/Volumes/APM909_B/Electrophysiology/DisplayCalibration/Setup3_L2.mat';
    [Filename Pathname Ind] = uigetfile('*.mat', 'Select luminance data', Default);
    LumFile = fullfile(Pathname, Filename);
end
load(LumFile);
if nargin < 2, fitType = 2;end            % extended power function
...
xlabel('Pixel Intensity');                                              % Add axis labels
ylabel('Luminance (cd/m^2)');
legend(LegendText, 'Location','NorthWest');
Title('Luminance measurements');
box off;
