function oimg=mkAnaglyph(img1,img2,mode,display_flg,save_flg, Filename)
...
elseif save_flg == 2
  fprintf('saving generated anaglyph as anaglyph_img.tif...');
  imwrite(gca, Filename,'tif','Resolution',300);
  disp('done.');
end
