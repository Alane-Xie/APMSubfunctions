function q=QuestCreateGauss(tGuess,tGuessSd,pThreshold,beta,delta,gamma,grain,range)
% q=QuestCreateGauss(tGuess,tGuessSd,pThreshold,beta,delta,gamma,[grain],[range])
%
...
if nargin<6 || nargin>8
    error('Usage: q=QuestCreateGauss(tGuess,tGuessSd,pThreshold,beta,delta,gamma,[grain],[range])')
end
if nargin<7
    grain=0.01;
end
