function [F, P, df] = Levenetest(X,alpha, print)
...
%           print:  flag for printing results to command line (default = 1)
%
%     Outputs:
%          F:   F statistic    
...
%
%  April 11, 2003. Created by A. Trujillo-Ortiz and R. Hernandez-Walls
...
%             Mexico.
%             atrujo@uabc.mx
% December 12, 2011 - Updated to return output variables and supress
%                     printing results to comand window. (APM)
%  
%
