...
if numel(Square.Size)==1
    Square.Size(2) = Square.Size(1);
end
...
SquareCornersX = (OuterBorders(1):(Square.Size(1)*2):floor(SquaresPerSide(1))*(Square.Size(1)*2))+Square.Size(1)/2;
SquareCornersY = (OuterBorders(2):(Square.Size(2)*2):floor(SquaresPerSide(2))*(Square.Size(2)*2))+Square.Size(2)/2;
