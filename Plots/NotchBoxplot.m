...
%
% INPUTS:
%       data0:      unsorted data in an mxn matrix (m samples, n columns);
...
%       BoxColour:  fill colour of the box area (deafult = [0 1 0]);  
%
...
LineColour = '-k';              % Default line colour is black
BoxColour = [0.5 1 0.5];        % Default box colour is green
